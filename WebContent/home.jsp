		...
		<div class="container">
			...
			<div class="slider">
				<div class="img-per-slider">
					<img id="img-1" class="active" src="${pageContext.request.contextPath}/images/system/adv/adv-1.png" data-value="naruto">
					<img id="img-2" src="${pageContext.request.contextPath}/images/system/adv/adv-2.png" data-value="garfield">
					<img id="img-3" src="${pageContext.request.contextPath}/images/system/adv/adv-3.png" data-value="marvel">
					<img id="img-4" src="${pageContext.request.contextPath}/images/system/adv/adv-4.png" data-value="personalizzata">
				</div>
			</div>
