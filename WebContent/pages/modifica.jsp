...
<form action="UpdateMaglietta" method="post" enctype="multipart/form-data">
    <fieldset>
        ...
        <label>Nome: <input type="text" name="nome" value="<%=magliettaBean.getNome()%>" required
                            autocomplete="off"></label> <br>
        <label>Prezzo: <input type="text" name="prezzo" value="<%=magliettaBean.getPrezzo()%>" required
                              autocomplete="off"></label> <br>
        <label>IVA: <input type="text" name="IVA" value="<%=magliettaBean.getPrezzo()%>" required
                           autocomplete="off"></label> <br>

        <label for="colore">Colore: </label>
        <select name="colore" id="colore">
            <option value="none" selected disabled hidden><%= magliettaBean.getColore() %>
            </option>
        ...
        <select name="tipo" id="tipo">
            <option value="none" selected disabled hidden><%= magliettaBean.getTipo() %>
            </option>
        ...
        <label>Descrizione: <br> <textarea name="descrizione" required
