...
<div class="box">
    <div class="metodo-di-pagamento">
        <div class="metodo-header"><h3>Metodo di pagamento:</h3></div>
        <div class="metodo-body"><% UtenteBean utenteBean = (UtenteBean) request.getSession().getAttribute("utente"); %>
            <label for="numCarta">Numero Carta</label>
            <input type="text" id="numCarta" name="numCarta" value="<%= utenteBean.getNumCarta()%>" disabled><br>
    ...
    <div class="modifica-pagamento" id="modifica-pagamento">
        ...
        <div class="pagamento-body">
            <form action="ModificaPagamento" method="POST">
                ...
                <input type="text" id="nomeCartaNuova" name="nomeCarta" required><br>
    ...
    <div class="indirizzo-spedizione">
        <div class="indirizzo-header"><h3>Indirizzo di spedizione:</h3></div>
        <div class="indirizzo-body">
            <label for="via-spedizione">Via </label>
            <input type="text" id="via-spedizione" name="via-spedizione"> <br>
            <label for="cap-spedizione">CAP </label>
            <input type="text" id="cap-spedizione" name="cap-spedizione"><br>
            <label for="citta-spedizione">Citt&#225; </label>
            <input type="text" id="citta-spedizione" name="citta-spedizione"><br>
        </div>
    </div>
...
<div class="riepilogo-ordine">
  <table>
      ...
      <tr class="prodotti-carrello" id="prodotti-carrello">
          ...
          <td colspan="2"><img class="immagine-prodotto"  src="../<%= magliettaOrdine.getMagliettaBean().getGrafica() %>" alt="<%= magliettaOrdine.getMagliettaBean().getNome() %>"></td>
